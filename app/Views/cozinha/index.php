...
ob_start();
?>
<h1 class="h4 mb-3 module-title"><i class="bi bi-fire me-2"></i>Painel da Cozinha</h1>
...
<input type="text" class="form-control mb-3" placeholder="Filtrar ao digitar..." data-filter-input="#tabela-cozinha">
<table class="table table-striped" id="tabela-cozinha" data-filter-table>
    <thead><tr><th>Pedido</th><th>Itens</th><th>Status</th></tr></thead>
    <tbody>
    <?php foreach ($registros as $r): ?>
        <tr>
            <td><?= htmlspecialchars((string) $r['pedido'], ENT_QUOTES, 'UTF-8') ?></td>
            <td><?= htmlspecialchars((string) $r['itens'], ENT_QUOTES, 'UTF-8') ?></td>
