...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h4 mb-0 module-title"><i class="bi bi-cash-coin me-2"></i>Movimentações Financeiras</h1>
    <a href="/financeiro/caixa" class="btn btn-outline-primary btn-sm">Controle de Caixa</a>
</div>
...
<input type="text" class="form-control mb-3" placeholder="Filtrar ao digitar..." data-filter-input="#tabela-financeiro">
<table class="table table-striped" id="tabela-financeiro" data-filter-table>
    <thead><tr><th>Descrição</th><th>Tipo</th><th>Valor</th></tr></thead>
    <tbody>
    <?php foreach ($registros as $r): ?>
        <tr>
            <td><?= htmlspecialchars((string) $r['descricao'], ENT_QUOTES, 'UTF-8') ?></td>
